'''
Implicit check-ins (time-ordered)
        ↓
LightGCN (collaborative structure)
        ↓
Hybrid Two-Tower
   • Item: GCN + Geo
   • User: GCN + Attention over history
        ↓
...
class HybridTwoTower(nn.Module):
    def __init__(self):
        ...
        self.attn = nn.Linear(TOWER_DIM, 1)
    ...
    def encode_users(self, users, item_emb):
        ...
        for u in users:
            ...
            hists.append((h * alpha.unsqueeze(1)).sum(0))
